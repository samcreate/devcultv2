...
(function() {
  var Config, accord, coffee, fs, path, _;
  ...
  Config = (function() {
    ...
    function Config(roots, opts) {
      ...
      this.open_browser = true;
      load_config.call(this);
      if (this.ignores == null) {
        this.ignores = [];
      }
      this.ignores = this.ignores.concat(['package.json', 'app*.coffee', "" + this.output + "/**/*"]);
      if (this.watcher_ignores == null) {
        this.watcher_ignores = [];
      }
      this.watcher_ignores = this.watcher_ignores.concat(['package.json', 'app.coffee', "" + this.output + "/**/*"]);
    ...
    Config.prototype.out = function(f, ext) {
      ...
      if (_.contains(this.dump_dirs, res[0])) {
        res.shift();
      }
    ...
    get_compilers = function() {
      var dep, err, local_compiler, pkg, pkg_json_path, res, _i, _len, _ref;
      res = {};
      ...
      _ref = Object.keys(pkg.dependencies);
